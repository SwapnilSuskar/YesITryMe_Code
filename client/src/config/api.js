...
export const API_ENDPOINTS = {
  ...
  videoTasks: {
    list: `${API_URL}/api/video-tasks`,
    get: `${API_URL}/api/video-tasks/:videoId`,
    myEngagements: `${API_URL}/api/video-tasks/:videoId/my-engagements`,
    stats: `${API_URL}/api/video-tasks/:videoId/stats`,
    comments: `${API_URL}/api/video-tasks/:videoId/comments`,
    shareToken: `${API_URL}/api/video-tasks/:videoId/share-token`,
