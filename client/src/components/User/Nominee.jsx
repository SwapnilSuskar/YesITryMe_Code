...
import { User, Phone, MapPin, Calendar, Edit3, Save, X, UserCheck } from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4 pt-4">
                <button
                  onClick={handleSave}
                  disabled={saving}
                  className="flex-1 flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 disabled:bg-green-300 text-white px-6 py-3 rounded-lg transition-colors"
                >
                  <Save size={18} />
